...
const ProductInfo: React.FC<ProductInfoProps> = ({ title, description, price }) => {
  return (
    <div className="box-border px-10 pt-5 w-full text-left max-sm:px-2.5 max-sm:text-center">
      <h2 className="mb-2.5 text-3xl font-[normal] text-zinc-800 max-sm:text-2xl">{title}</h2>
      <p className="mb-5 text-lg text-neutral-600 max-sm:text-base">{description}</p>
