...
const Header: React.FC<HeaderProps> = ({ globalData }) => {
  ...
  const headerData = {
    siteName: globalData.site_name, // Sécurisé
    gitHubUrl: globalData.header.github.icon.data.attributes.url, // Sécurisé
  };
  return (
