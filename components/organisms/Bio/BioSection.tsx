...
lg:before:bg-[100%_5%] before:bg-[50%_70%]  bg-blend-overlaybox-border relative flex flex-col lg:flex-row bg-secondary justify-center w-full shrink-0 p-5 lg:p-0 min-h-[100vh]">
      ...
      <div
        ref={headingRef}
        className="opacity-0 fade-in pt-20 lg:pt-36 box-border flex relative flex-col justify-center grow shrink-0 self-stretch  w-full max-w-[1200px] 2xl:max-w-[1300px] ">
